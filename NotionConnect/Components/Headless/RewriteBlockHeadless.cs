...
{
    public class RewriteBlocksHeadlessComponent : GH_Component
    {
        public RewriteBlocksHeadlessComponent()
          : base("Rewrite Blocks Headless", "RewriteBlocksHL",
              "Erases all blocks on a Notion page and appends new ones. Send is triggered by a boolean toggle — compatible with ShapeDiver and other headless environments.",
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddBooleanParameter("Send", "S", "Set to True to trigger the rewrite. Rises on False→True transition only.", GH_ParamAccess.item, false);
        }
        ...
        protected override System.Drawing.Bitmap Icon => Properties.Resources.NC_HeadlessBLRewrite;
        public override Guid ComponentGuid => new Guid("DF73F9B5-A85C-4FE0-A85A-287FC1EB177D");
    }
}